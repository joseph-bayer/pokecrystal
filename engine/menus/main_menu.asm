	...
	const MAINMENUITEM_MON_COLOR_PICKER     ; 6
	const MAINMENUITEM_TRAINER_COLOR_PICKER ; 7
...
; entries correspond to MAINMENUITEM_* constants
	...
	dw MainMenu_MonColorPicker
	dw MainMenu_TrainerColorPicker
...
; entries correspond to MAINMENU_* constants
	...
	db MAINMENUITEM_MON_COLOR_PICKER
	db MAINMENUITEM_TRAINER_COLOR_PICKER
	db -1
